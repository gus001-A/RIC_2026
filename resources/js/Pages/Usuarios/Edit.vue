                        ...
                        <div class="form-section">
                            <div class="section-header">
                                ...
                                <div class="section-title-group">
                                    ...
                                    <p class="section-subtitle">Deje el campo de contraseña vacío para mantener la actual</p>
                                </div>
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <div class="password-hint">
                                        <svg class="hint-icon" fill="none" stroke="#6b7280" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                        </svg>
                                        <span>Deje en blanco para mantener la contraseña actual</span>
                                    </div>
                                </div>
...
const form = useForm({
    ...
    empresas: props.empresasUsuario || []
});
...
const requiredFields = computed(() => {
    return ['nombre_completo', 'nombre_usuario', 'email', 'tipo_usuario'];
});
