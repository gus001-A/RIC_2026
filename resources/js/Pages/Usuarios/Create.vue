                    ...
                    <form @submit.prevent="submit" id="usuarioForm" novalidate>
                        ...
                        <div class="tabs-premium">
                            <button type="button" class="tab-premium" :class="{ active: activeTab === 'datos' }" @click="activeTab = 'datos'">
                                ...
                                <span v-else-if="isDatosComplete" class="tab-dot success-dot"></span>
                            </button>
                            <button type="button" class="tab-premium" :class="{ active: activeTab === 'credenciales' }" @click="activeTab = 'credenciales'">
                                ...
                                <span v-else-if="isCredencialesComplete" class="tab-dot success-dot"></span>
                            </button>
...
const isDatosComplete = computed(() =>
    !!form.nombre_completo && !!form.nombre_usuario && !!form.email && !!form.tipo_usuario && !hasDatosErrors.value,
);
...
const isCredencialesComplete = computed(() =>
    !!form.password && !!form.password_confirmation && !hasCredencialesErrors.value,
);
...
const submit = () => {
    ...
    if (!isFormValid.value) {
        ...
        } else if (hasCredencialesErrors.value || !form.password || !form.password_confirmation) {
    ...
    form.post(route('usuarios.store'), {
        onError: (errors) => {
            ...
            notify.error('Revisa los datos del formulario e intenta nuevamente.', 'No se pudo crear');
        },
    });
};
</script>
...
/* Sólo se muestra una sección a la vez: sin margen inferior y con animación */
