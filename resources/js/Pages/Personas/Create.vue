            ...
            <div class="header-wrapper">
                <div class="header-left">
                    ...
                    <div class="header-content">
                        <h2 class="header-title">Nueva Persona</h2>
                        <p class="header-subtitle">Complete el formulario para registrar una nueva persona</p>
                    </div>
                </div>
                        ...
                        <div class="form-actions">
                            <div class="actions-right">
                                ...
                                <button type="submit" 
                                    ...
                                    {{ form.processing ? 'Guardando...' : 'Crear Persona' }}
                                </button>
                            </div>
                        </div>
                    </form>
...
// ============================================
const onTipoChange = () => {
    // Limpiar campos específicos del representante
        ...
        onError: (errors) => {
            if (errors.rfc) {
                ...
                alertRef.value?.show({
                    ...
                    message: 'Ocurrió un error al registrar la persona. Verifique los datos e intente nuevamente.',
