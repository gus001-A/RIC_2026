        ...
        <template #header>
            <div class="header-wrapper-premium">
                <div class="header-left-premium">
                    ...
                    <div>
                        <h2 class="header-title-premium">Registrar Persona</h2>
                        <p class="header-subtitle-premium">Ingrese la información de la nueva persona en el sistema</p>
                    </div>
                </div>
                ...
                <div class="form-card-premium">
                    <form @submit.prevent="submit" id="personaForm" novalidate>
                        ...
                        <div class="tab-content-premium">
                            ...
                            <!-- TAB 3: REPRESENTANTE LEGAL (Sexo primero, luego Correo) -->
                            <div v-show="activeTab === 'representante'" class="tab-pane-premium">
                                <div class="section-premium section-representante">
                                    ...
                                    <div class="grid-representante">
                                        ...
                                        <!-- Fila 2: Fecha Nacimiento + Sexo + Correo (Sexo antes que Correo) -->
                                        <div class="field-premium">
...
const props = defineProps({
    // No hay props porque es para registrar
});
...
// ============================================
// FORMULARIO (VACÍO PARA REGISTRO)
// ============================================
const form = useForm({
    tipo_persona: 'FISICA',
    empleado: 0,
    ...
    representante_sexo: 'NO_ESPECIFICADO',
    representante_email: '',
    representante_telefono_particular: '',
    representante_telefono_trabajo: '',
    representante_extension_trabajo: '',
    ...
    form.post(route('personas.store'), {
        onSuccess: () => {
            alertRef.value?.show({
                ...
                message: 'La persona se ha registrado exitosamente en el sistema.',
