            ...
            <div class="header-wrapper">
                <div class="header-left">
                    ...
                    <div class="header-content">
                        <h2 class="header-title">✨ Nueva Empresa</h2>
                        <p class="header-subtitle">Complete el formulario para registrar una nueva empresa en el sistema</p>
                    </div>
                </div>
...
const validateCURP = () => {
    ...
    // Actualizar el valor del formulario con la versión limpia
    ...
    // Si llegamos aquí, la CURP es válida
    curpError.value = '';
};
...
const submit = () => {
    ...
    form.post(route('empresas.store'), {
        ...
        onError: (errors) => {
            // Si el error es por RFC duplicado, mostrar mensaje amigable
            if (errors.rfc) {
                alertRef.value?.show({
                    type: 'error',
                    title: '❌ RFC duplicado',
